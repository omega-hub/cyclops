...
///////////////////////////////////////////////////////////////////////////////
float computeSoftShadowMap(sampler2DShadow shadowTexture, vec4 sceneShadowProj, float osgShadow_softnessWidth, float osgShadow_jitteringScale)
{
	...
	{ 
		...
		shadow +=  shadow2DProj( shadowTexture, smCoord ).x * pass_div; 
	...
	{ 
		...
		{ 
		  ...
		  smCoord.xy = sceneShadowProj.xy  + offset.xy * softFactor; 
		  shadow +=  shadow2DProj( shadowTexture, smCoord ).x * INV_SAMPLECOUNT; 
